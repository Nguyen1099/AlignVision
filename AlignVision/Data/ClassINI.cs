...
namespace AlignVision
{
    public class ClassINI
    {
                                ...
                                string defaultValue)
        {
            ...
            StringBuilder retval = new StringBuilder(ClassINI.MaxSectionSize);

            NativeMethods.GetPrivateProfileString(sectionName,
                                                  keyName,
                                                  defaultValue,
                                                  retval,
                                                  ClassINI.MaxSectionSize,
                                                  m_path);
        ...
        public bool GetBool(string sectionName,
                            string keyName,
                            bool bValue)
        {
            if (sectionName == null)
            ...
            int nData = 0, nRet = 0;
            nData = bValue == true ? 1 : 0;
            nRet = NativeMethods.GetPrivateProfileInt(sectionName, keyName, nData, m_path);
            if (0 == nRet)
                return false;
            else
                return true;
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(ClassINI.MaxSectionSize);
        ...
        public string[] GetSectionNames()
        {
            ...
            try
            {
                ...
                len = NativeMethods.GetPrivateProfileSectionNames(ptr,
                    ClassINI.MaxSectionSize, m_path);
        ...
        public void WriteValue(string sectionName, string keyName, bool value)
        {
            ...
            if (true == value)
                ...
                nData = 0;
            WriteValue(sectionName, keyName, nData);
        }
